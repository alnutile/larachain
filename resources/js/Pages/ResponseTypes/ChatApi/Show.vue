                            ...
                            <div class="max-w-7xl mx-auto sm:py-10 sm:px-6 lg:px-8">
                                <FormSection>
                                    ...
                                    <template #form_description>
                                        <h3 class="text-xl text-gray-900 mb-4">Response Types Chat API</h3>
                                        <div>
                                            The URL you can use for this API is:
                                            <div class="bg-gray-100 p-2">
                                                <ul>
                                                    <li>{{ usePage().props.app_url }}/api/outbounds/{{outbound.id}}/response_types/{{response_type.id}}/chat_api?question=Your Question</li>
                                                    <li><span class="font-semibold">method:</span> 'GET'</li>
                                                    <li><span class="font-semibold">header:</span> {Authorization: Bearer YOUR_TOKEN_FROM_PROFILE_AREA, Accept: application/json}</li>
                                                    <li><span class="font-semibold">response:</span> {data: "Some answer"}</li>
                                                </ul>
                                            </div>
                                        </div>
