...
{
    public $signature = 'larachain:transformer:create';

    public $description = 'Generate the needed files for a new Transformer';

    public function handle(): int
    {
        $name = $this->ask('What is the name of this Transformer type, example Html2Text');
